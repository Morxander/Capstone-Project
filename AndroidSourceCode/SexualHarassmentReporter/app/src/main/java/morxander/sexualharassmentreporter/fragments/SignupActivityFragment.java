            ...
            btn_signup.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(validateEmail() && validatePassword()){
                        ...
                        loading_dialog.show();
                        client.post(getContext(), getString(R.string.api_base_url) + getString(R.string.api_signup_url), params, new AsyncHttpResponseHandler() {
                            @Override
                            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                                ...
                                try {
                                    ...
                                    if (json.getBoolean(getString(R.string.api_response_status))) {
                                        ...
                                        db.save();
                                        Toast.makeText(getContext(), json.getString(getString(R.string.api_response_token)), Toast.LENGTH_LONG).show();
