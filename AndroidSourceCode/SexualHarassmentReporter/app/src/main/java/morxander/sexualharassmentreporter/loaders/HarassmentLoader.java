 ...
 */
public class HarassmentLoader extends AsyncTaskLoader<List<Harassment>> {

    public HarassmentLoader(Context context) {
        super(context);
    }
    ...
    public List<Harassment> loadInBackground() {
        try {
            ...
            String url = getContext().getString(R.string.api_base_url) + getContext().getString(R.string.api_harassment_list);
            url = url + "?" + getContext().getString(R.string.api_user_id) + "=" + user_id;
            url = url + "&" + getContext().getString(R.string.api_token) + "=" + api_token;
            url = url + "&" + "city_id" + "=" + HarassmentsListActivityFragment.city_id;
